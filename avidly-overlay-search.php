 ...
 * Plugin URI:        https://avidly.fi
 * Description:       Accessible overlay / fullscreen search.
 * Version:           2.0.0
...
function activate_overlay_search() {
	...
	A11y_Overlay_Search_Activator::activate();
}
...
function deactivate_overlay_search() {
	...
	A11y_Overlay_Search_Deactivator::deactivate();
}
...
function run_overlay_search() {
	...
	$plugin = new A11y_Overlay_Search();
	$plugin->run();
