...
class Overlay_Search {
	...
	public function __construct() {
		if ( defined( 'OVERLAY_SEARCH_VERSION' ) ) {
			$this->version = OVERLAY_SEARCH_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'overlay-search';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-overlay-search-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-overlay-search-i18n.php';
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_footer', $plugin_public, 'dialog', 1 );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'search_scripts' );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'search_translations' );
